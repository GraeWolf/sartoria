...
```bash
./scripts/build-sartoria-desktop.sh   # 0.0.3 (Nerd Fonts)
./scripts/build-sartoria-nvidia.sh
sudo apt-get install ./lab/cache/sartoria-desktop_0.0.3_all.deb ./lab/cache/sartoria-nvidia_0.0.2_all.deb
sudo reboot
```
